export const TARGET_SETUP_FEATURES = {
  Create: 'can_create_target_setup',
  Edit: 'can_edit_target_setup',
  View: 'can_view_target_setup',
};
...
export const TARGET_SETUP_COMMANDS = {
  ...
  EditDraft:
    'Bits.RFIndicator.Application.Commands.IndicatorTarget.EditTargetSetupAsDraftCommand',
  StatusUpdate:
    'Bits.RFIndicator.Application.Commands.IndicatorTarget.ChangeTargetSetupStatusCommand',
};

export const TARGET_SETUP_QUERY_TEMPLATES = {
  List: 'target-setup-query',
  Details: 'target-setup-query',
};
