...
import {
  ...
  FusePlatformService,
} from '@platform-ui/platform-bootstrap-template/@fuse';
import { combineLatest, filter, map, Subject, takeUntil } from 'rxjs';
import { EmptyLayoutComponent } from '@/app/layout/empty/empty.component';
import { ClassyLayoutComponent } from '@/app/layout/vertical/classy/classy.component';
import { DenseLayoutComponent } from '@/app/layout/vertical/dense/dense.component';
...
export class LayoutComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    @Inject('config') public envConfig: any,
